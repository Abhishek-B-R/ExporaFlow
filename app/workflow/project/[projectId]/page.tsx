    ...
    <>
      {isLoading ? (
        ...
        <WorkflowLayout windowSvg={RAW_ICONS.RubiksCube} windowTitle="Projects">
          <div className="border h-10 rounded border-(--border) bg-(--surface-1) flex items-center justify-between px-4">
            <div className=" flex gap-x-2 items-center ">
              ...
              <div className="flex h-7 items-center gap-x-1 cursor-pointer border border-(--border) px-2 rounded hover:bg-(--surface-2) transition-all duration-300">
            ...
            <div className="flex gap-x-2 md:gap-x-4 ">
              <div className="flex h-7 items-center gap-x-1 cursor-pointer border border-transparent px-2 rounded-lg hover:bg-(--surface-2) hover:border-(--border-strong) transition-all duration-300">
