...
export const TermsOptions: {
  ...
  },
  {
    ...
    subTitle: "",
    points: [
      "ExporaFlow provides software that users can deploy on their own infrastructure",
  ...
  },
  {
    ...
    subTitle: "ExporaFlow is licensed under the Apache 2.0 License:",
    points: [
...
export const PrivacyOptions: {
  ...
  },
  {
    ...
    subTitle: "",
    points: [
      "When you self-host ExporaFlow, your email data remains entirely under your control",
