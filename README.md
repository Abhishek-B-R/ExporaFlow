...
> **Modern Issue Tracking Platform** - Keep projects, issues, and sprints flowing with a clean, fast workflow UI.
...
git clone https://github.com/your-org/exporaflow.git
cd exporaflow
...
Visit [http://localhost:3000](http://localhost:3000) to see ExporaFlow in action!

## 📚 Documentation

- **[Setup Guide](SETUP.md)** - Complete local development setup
- **[Contributing Guide](CONTRIBUTING.md)** - How to contribute to ExporaFlow
...
- Authentication uses **NextAuth** with **Google/GitHub OAuth**.
- Authorization is enforced at the API layer with project roles: **Admin, Manager, Engineer, QA, Viewer**.
